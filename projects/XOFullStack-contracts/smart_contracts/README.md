...
By the default the template creates a single `HelloWorld` contract under tic_tac_toe_single_player folder in the `smart_contracts` directory. To add a new contract:
